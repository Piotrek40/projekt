...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Dn,depthTest:!1,depthWrite:!1})}function Lg(s,e,t){let n=new Float32Array(Yi),i=new P(0,1,0);return new jt({name:"SphericalGaussianBlur",defines:{n:Yi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Go(),fragmentShader:`
...
`)}var D0={[Vc]:"Linear",[Hc]:"Reinhard",[Gc]:"Cineon",[Wc]:"ACESFilmic",[Er]:"AgX",[qc]:"Neutral",[Xc]:"Custom"};function U0(s,e){let t=D0[e];return t===void 0?(ve("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+s+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var zo=new P;function F0(){ze.getLuminanceCoefficients(zo);let s=zo.x.toFixed(4),e=zo.y.toFixed(4),t=zo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+m);let C=R+p+a,M=R+m+o,w=Ku(i,i.VERTEX_SHADER,C),S=Ku(i,i.FRAGMENT_SHADER,M);i.attachShader(y,w),i.attachShader(y,S),t.index0AttributeName!==void 0?i.bindAttribLocation(y,0,t.index0AttributeName):t.hasPositionAttribute===!0&&i.bindAttribLocation(y,0,"position"),i.linkProgram(y);function E(b){if(s.debug.checkShaderErrors){let N=i.getProgramInfoLog(y)||"",H=i.getShaderInfoLog(w)||"",Y=i.getShaderInfoLog(S)||"",z=N.trim(),X=H.trim(),G=Y.trim(),$=!0,Q=!0;if(i.getProgramParameter(y,i.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,y,w,S);else{let ce=$u(i,w,"vertex"),pe=$u(i,S,"fragment");Ce("WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(y,i.VALIDATE_STATUS)+`
...
}`,m_=[new P(1,0,0),new P(-1,0,0),new P(0,1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1)],g_=[new P(0,-1,0),new P(0,-1,0),new P(0,0,1),new P(0,0,-1),new P(0,-1,0),new P(0,-1,0)],rd=new Le,Ur=new P,fl=new P;function __(s,e,t){let n=new Ts,i=new Fe,r=new Fe,a=new je,o=new Da,c=new Ua,l={},h=t.maxTextureSize,d={[_n]:zt,[zt]:_n,[an]:an},u=new jt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Fe},radius:{value:4}},vertexShader:f_,fragmentShader:p_}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let g=new Lt;g.setAttribute("position",new St(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new Et(g,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Gi;let m=this.type;this.render=function(S,E,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||S.length===0)return;this.type===jh&&(ve("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Gi);let A=s.getRenderTarget(),L=s.getActiveCubeFace(),b=s.getActiveMipmapLevel(),N=s.state;N.setBlending(Dn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);let H=m!==this.type;H&&E.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(z=>z.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,z=S.length;Y<z;Y++){let X=S[Y],G=X.shadow;if(G===void 0){ve("WebGLShadowMap:",X,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;i.copy(G.mapSize);let $=G.getFrameExtents();i.multiply($),r.copy(G.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/$.x),i.x=r.x*$.x,G.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/$.y),i.y=r.y*$.y,G.mapSize.y=r.y));let Q=s.state.buffers.depth.getReversed();if(G.camera._reversedDepth=Q,G.map===null||H===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Cs){if(X.isPointLight){ve("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Jt(i.x,i.y,{format:Mi,type:Un,minFilter:gt,magFilter:gt,generateMipmaps:!1}),G.map.texture.name=X.name+".shadowMap",G.map.depthTexture=new Yn(i.x,i.y,Qt),G.map.depthTexture.name=X.name+".shadowMapDepth",G.map.depthTexture.format=Pn,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=mt,G.map.depthTexture.magFilter=mt}else X.isPointLight?(G.map=new Vo(i.x),G.map.depthTexture=new La(i.x,Tn)):(G.map=new Jt(i.x,i.y),G.map.depthTexture=new Yn(i.x,i.y,Tn)),G.map.depthTexture.name=X.name+".shadowMap",G.map.depthTexture.format=Pn,this.type===Gi?(G.map.depthTexture.compareFunction=Q?Oo:Fo,G.map.depthTexture.minFilter=gt,G.map.depthTexture.magFilter=gt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=mt,G.map.depthTexture.magFilter=mt);G.camera.updateProjectionMatrix()}let ce=G.map.isWebGLCubeRenderTarget?6:1;for(let pe=0;pe<ce;pe++){if(G.map.isWebGLCubeRenderTarget)s.setRenderTarget(G.map,pe),s.clear();else{pe===0&&(s.setRenderTarget(G.map),s.clear());let _e=G.getViewport(pe);a.set(r.x*_e.x,r.y*_e.y,r.x*_e.z,r.y*_e.w),N.viewport(a)}if(X.isPointLight){let _e=G.camera,Xe=G.matrix,ot=X.distance||_e.far;ot!==_e.far&&(_e.far=ot,_e.updateProjectionMatrix()),Ur.setFromMatrixPosition(X.matrixWorld),_e.position.copy(Ur),fl.copy(_e.position),fl.add(m_[pe]),_e.up.copy(g_[pe]),_e.lookAt(fl),_e.updateMatrixWorld(),Xe.makeTranslation(-Ur.x,-Ur.y,-Ur.z),rd.multiplyMatrices(_e.projectionMatrix,_e.matrixWorldInverse),G._frustum.setFromProjectionMatrix(rd,_e.coordinateSystem,_e.reversedDepth)}else G.updateMatrices(X);n=G.getFrustum(),M(E,x,G.camera,X,this.type)}G.isPointLightShadow!==!0&&this.type===Cs&&R(G,x),G.needsUpdate=!1}m=this.type,p.needsUpdate=!1,s.setRenderTarget(A,L,b)};function R(S,E){let x=e.update(y);u.defines.VSM_SAMPLES!==S.blurSamples&&(u.defines.VSM_SAMPLES=S.blurSamples,f.defines.VSM_SAMPLES=S.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),S.mapPass===null&&(S.mapPass=new Jt(i.x,i.y,{format:Mi,type:Un})),u.uniforms.shadow_pass.value=S.map.depthTexture,u.uniforms.resolution.value=S.mapSize,u.uniforms.radius.value=S.radius,s.setRenderTarget(S.mapPass),s.clear(),s.renderBufferDirect(E,null,x,u,y,null),f.uniforms.shadow_pass.value=S.mapPass.texture,f.uniforms.resolution.value=S.mapSize,f.uniforms.radius.value=S.radius,s.setRenderTarget(S.map),s.clear(),s.renderBufferDirect(E,null,x,f,y,null)}function C(S,E,x,A){let L=null,b=x.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(b!==void 0)L=b;else if(L=x.isPointLight===!0?c:o,s.localClippingEnabled&&E.clipShadows===!0&&Array.isArray(E.clippingPlanes)&&E.clippingPlanes.length!==0||E.displacementMap&&E.displacementScale!==0||E.alphaMap&&E.alphaTest>0||E.map&&E.alphaTest>0||E.alphaToCoverage===!0){let N=L.uuid,H=E.uuid,Y=l[N];Y===void 0&&(Y={},l[N]=Y);let z=Y[H];z===void 0&&(z=L.clone(),Y[H]=z,E.addEventListener("dispose",w)),L=z}if(L.visible=E.visible,L.wireframe=E.wireframe,A===Cs?L.side=E.shadowSide!==null?E.shadowSide:E.side:L.side=E.shadowSide!==null?E.shadowSide:d[E.side],L.alphaMap=E.alphaMap,L.alphaTest=E.alphaToCoverage===!0?.5:E.alphaTest,L.map=E.map,L.clipShadows=E.clipShadows,L.clippingPlanes=E.clippingPlanes,L.clipIntersection=E.clipIntersection,L.displacementMap=E.displacementMap,L.displacementScale=E.displacementScale,L.displacementBias=E.displacementBias,L.wireframeLinewidth=E.wireframeLinewidth,L.linewidth=E.linewidth,x.isPointLight===!0&&L.isMeshDistanceMaterial===!0){let N=s.properties.get(L);N.light=x}return L}function M(S,E,x,A,L){if(S.visible===!1)return;if(S.layers.test(E.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&L===Cs)&&(!S.frustumCulled||n.intersectsObject(S))){S.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,S.matrixWorld);let H=e.update(S),Y=S.material;if(Array.isArray(Y)){let z=H.groups;for(let X=0,G=z.length;X<G;X++){let $=z[X],Q=Y[$.materialIndex];if(Q&&Q.visible){let ce=C(S,Q,A,L);S.onBeforeShadow(s,S,E,x,H,ce,$),s.renderBufferDirect(x,null,H,ce,S,$),S.onAfterShadow(s,S,E,x,H,ce,$)}}}else if(Y.visible){let z=C(S,Y,A,L);S.onBeforeShadow(s,S,E,x,H,z,null),s.renderBufferDirect(x,null,H,z,S,null),S.onAfterShadow(s,S,E,x,H,z,null)}}let N=S.children;for(let H=0,Y=N.length;H<Y;H++)M(N[H],E,x,A,L)}function w(S){S.target.removeEventListener("dispose",w);for(let x in l){let A=l[x],L=S.target.uuid;L in A&&(A[L].dispose(),delete A[L])}}}function x_(s,e){function t(){let I=!1,ne=new je,Z=null,oe=new je(0,0,0,0);return{setMask:function(fe){Z!==fe&&!I&&(s.colorMask(fe,fe,fe,fe),Z=fe)},setLocked:function(fe){I=fe},setClear:function(fe,j,Me,xe,lt){lt===!0&&(fe*=xe,j*=xe,Me*=xe),ne.set(fe,j,Me,xe),oe.equals(ne)===!1&&(s.clearColor(fe,j,Me,xe),oe.copy(ne))},reset:function(){I=!1,Z=null,oe.set(-1,0,0,0)}}}function n(){let I=!1,ne=!1,Z=null,oe=null,fe=null;return{setReversed:function(j){if(ne!==j){let Me=e.get("EXT_clip_control");j?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),ne=j;let xe=fe;fe=null,this.setClear(xe)}},getReversed:function(){return ne},setTest:function(j){j?ee(s.DEPTH_TEST):Ie(s.DEPTH_TEST)},setMask:function(j){Z!==j&&!I&&(s.depthMask(j),Z=j)},setFunc:function(j){if(ne&&(j=Du[j]),oe!==j){switch(j){case ya:s.depthFunc(s.NEVER);break;case va:s.depthFunc(s.ALWAYS);break;case Ma:s.depthFunc(s.LESS);break;case Ui:s.depthFunc(s.LEQUAL);break;case Sa:s.depthFunc(s.EQUAL);break;case ba:s.depthFunc(s.GEQUAL);break;case Ta:s.depthFunc(s.GREATER);break;case Ea:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}oe=j}},setLocked:function(j){I=j},setClear:function(j){fe!==j&&(fe=j,ne&&(j=1-j),s.clearDepth(j))},reset:function(){I=!1,Z=null,oe=null,fe=null,ne=!1}}}function i(){let I=!1,ne=null,Z=null,oe=null,fe=null,j=null,Me=null,xe=null,lt=null;return{setTest:function(st){I||(st?ee(s.STENCIL_TEST):Ie(s.STENCIL_TEST))},setMask:function(st){ne!==st&&!I&&(s.stencilMask(st),ne=st)},setFunc:function(st,En,An){(Z!==st||oe!==En||fe!==An)&&(s.stencilFunc(st,En,An),Z=st,oe=En,fe=An)},setOp:function(st,En,An){(j!==st||Me!==En||xe!==An)&&(s.stencilOp(st,En,An),j=st,Me=En,xe=An)},setLocked:function(st){I=st},setClear:function(st){lt!==st&&(s.clearStencil(st),lt=st)},reset:function(){I=!1,ne=null,Z=null,oe=null,fe=null,j=null,Me=null,xe=null,lt=null}}}let r=new t,a=new n,o=new i,c=new WeakMap,l=new WeakMap,h={},d={},u={},f=new WeakMap,g=[],y=null,p=!1,m=null,R=null,C=null,M=null,w=null,S=null,E=null,x=new Ae(0,0,0),A=0,L=!1,b=null,N=null,H=null,Y=null,z=null,X=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS),G=!1,$=0,Q=s.getParameter(s.VERSION);Q.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(Q)[1]),G=$>=1):Q.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),G=$>=2);let ce=null,pe={},_e=s.getParameter(s.SCISSOR_BOX),Xe=s.getParameter(s.VIEWPORT),ot=new je().fromArray(_e),qe=new je().fromArray(Xe);function J(I,ne,Z,oe){let fe=new Uint8Array(4),j=s.createTexture();s.bindTexture(I,j),s.texParameteri(I,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(I,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Me=0;Me<Z;Me++)I===s.TEXTURE_3D||I===s.TEXTURE_2D_ARRAY?s.texImage3D(ne,0,s.RGBA,1,1,oe,0,s.RGBA,s.UNSIGNED_BYTE,fe):s.texImage2D(ne+Me,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,fe);return j}let ie={};ie[s.TEXTURE_2D]=J(s.TEXTURE_2D,s.TEXTURE_2D,1),ie[s.TEXTURE_CUBE_MAP]=J(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),ie[s.TEXTURE_2D_ARRAY]=J(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),ie[s.TEXTURE_3D]=J(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ee(s.DEPTH_TEST),a.setFunc(Ui),xt(!1),Tt(Fc),ee(s.CULL_FACE),Ye(Dn);function ee(I){h[I]!==!0&&(s.enable(I),h[I]=!0)}function Ie(I){h[I]!==!1&&(s.disable(I),h[I]=!1)}function Ne(I,ne){return u[I]!==ne?(s.bindFramebuffer(I,ne),u[I]=ne,I===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=ne),I===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=ne),!0):!1}function we(I,ne){let Z=g,oe=!1;if(I){Z=f.get(ne),Z===void 0&&(Z=[],f.set(ne,Z));let fe=I.textures;if(Z.length!==fe.length||Z[0]!==s.COLOR_ATTACHMENT0){for(let j=0,Me=fe.length;j<Me;j++)Z[j]=s.COLOR_ATTACHMENT0+j;Z.length=fe.length,oe=!0}}else Z[0]!==s.BACK&&(Z[0]=s.BACK,oe=!0);oe&&s.drawBuffers(Z)}function ut(I){return y!==I?(s.useProgram(I),y=I,!0):!1}let He={[pi]:s.FUNC_ADD,[eu]:s.FUNC_SUBTRACT,[tu]:s.FUNC_REVERSE_SUBTRACT};He[nu]=s.MIN,He[iu]=s.MAX;let tt={[su]:s.ZERO,[ru]:s.ONE,[au]:s.SRC_COLOR,[_a]:s.SRC_ALPHA,[du]:s.SRC_ALPHA_SATURATE,[hu]:s.DST_COLOR,[cu]:s.DST_ALPHA,[ou]:s.ONE_MINUS_SRC_COLOR,[xa]:s.ONE_MINUS_SRC_ALPHA,[uu]:s.ONE_MINUS_DST_COLOR,[lu]:s.ONE_MINUS_DST_ALPHA,[fu]:s.CONSTANT_COLOR,[pu]:s.ONE_MINUS_CONSTANT_COLOR,[mu]:s.CONSTANT_ALPHA,[gu]:s.ONE_MINUS_CONSTANT_ALPHA};function Ye(I,ne,Z,oe,fe,j,Me,xe,lt,st){if(I===Dn){p===!0&&(Ie(s.BLEND),p=!1);return}if(p===!1&&(ee(s.BLEND),p=!0),I!==Qh){if(I!==m||st!==L){if((R!==pi||w!==pi)&&(s.blendEquation(s.FUNC_ADD),R=pi,w=pi),st)switch(I){case Di:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Oc:s.blendFunc(s.ONE,s.ONE);break;case Bc:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case zc:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:Ce("WebGLState: Invalid blending: ",I);break}else switch(I){case Di:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Oc:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case Bc:Ce("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case zc:Ce("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ce("WebGLState: Invalid blending: ",I);break}C=null,M=null,S=null,E=null,x.set(0,0,0),A=0,m=I,L=st}return}fe=fe||ne,j=j||Z,Me=Me||oe,(ne!==R||fe!==w)&&(s.blendEquationSeparate(He[ne],He[fe]),R=ne,w=fe),(Z!==C||oe!==M||j!==S||Me!==E)&&(s.blendFuncSeparate(tt[Z],tt[oe],tt[j],tt[Me]),C=Z,M=oe,S=j,E=Me),(xe.equals(x)===!1||lt!==A)&&(s.blendColor(xe.r,xe.g,xe.b,lt),x.copy(xe),A=lt),m=I,L=!1}function Ge(I,ne){I.side===an?Ie(s.CULL_FACE):ee(s.CULL_FACE);let Z=I.side===zt;ne&&(Z=!Z),xt(Z),I.blending===Di&&I.transparent===!1?Ye(Dn):Ye(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),a.setFunc(I.depthFunc),a.setTest(I.depthTest),a.setMask(I.depthWrite),r.setMask(I.colorWrite);let oe=I.stencilWrite;o.setTest(oe),oe&&(o.setMask(I.stencilWriteMask),o.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),o.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),Pt(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ee(s.SAMPLE_ALPHA_TO_COVERAGE):Ie(s.SAMPLE_ALPHA_TO_COVERAGE)}function xt(I){b!==I&&(I?s.frontFace(s.CW):s.frontFace(s.CCW),b=I)}function Tt(I){I!==Jh?(ee(s.CULL_FACE),I!==N&&(I===Fc?s.cullFace(s.BACK):I===$h?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Ie(s.CULL_FACE),N=I}function Rt(I){I!==H&&(G&&s.lineWidth(I),H=I)}function Pt(I,ne,Z){I?(ee(s.POLYGON_OFFSET_FILL),(Y!==ne||z!==Z)&&(Y=ne,z=Z,a.getReversed()&&(ne=-ne),s.polygonOffset(ne,Z))):Ie(s.POLYGON_OFFSET_FILL)}function ct(I){I?ee(s.SCISSOR_TEST):Ie(s.SCISSOR_TEST)}function yt(I){I===void 0&&(I=s.TEXTURE0+X-1),ce!==I&&(s.activeTexture(I),ce=I)}function D(I,ne,Z){Z===void 0&&(ce===null?Z=s.TEXTURE0+X-1:Z=ce);let oe=pe[Z];oe===void 0&&(oe={type:void 0,texture:void 0},pe[Z]=oe),(oe.type!==I||oe.texture!==ne)&&(ce!==Z&&(s.activeTexture(Z),ce=Z),s.bindTexture(I,ne||ie[I]),oe.type=I,oe.texture=ne)}function Vt(){let I=pe[ce];I!==void 0&&I.type!==void 0&&(s.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function Je(){try{s.compressedTexImage2D(...arguments)}catch(I){Ce("WebGLState:",I)}}function T(){try{s.compressedTexImage3D(...arguments)}catch(I){Ce("WebGLState:",I)}}function _(){try{s.texSubImage2D(...arguments)}catch(I){Ce("WebGLState:",I)}}function F(){try{s.texSubImage3D(...arguments)}catch(I){Ce("WebGLState:",I)}}function k(){try{s.compressedTexSubImage2D(...arguments)}catch(I){Ce("WebGLState:",I)}}function W(){try{s.compressedTexSubImage3D(...arguments)}catch(I){Ce("WebGLState:",I)}}function te(){try{s.texStorage2D(...arguments)}catch(I){Ce("WebGLState:",I)}}function se(){try{s.texStorage3D(...arguments)}catch(I){Ce("WebGLState:",I)}}function q(){try{s.texImage2D(...arguments)}catch(I){Ce("WebGLState:",I)}}function K(){try{s.texImage3D(...arguments)}catch(I){Ce("WebGLState:",I)}}function re(I){return d[I]!==void 0?d[I]:s.getParameter(I)}function Se(I,ne){d[I]!==ne&&(s.pixelStorei(I,ne),d[I]=ne)}function le(I){ot.equals(I)===!1&&(s.scissor(I.x,I.y,I.z,I.w),ot.copy(I))}function ae(I){qe.equals(I)===!1&&(s.viewport(I.x,I.y,I.z,I.w),qe.copy(I))}function Ee(I,ne){let Z=l.get(ne);Z===void 0&&(Z=new WeakMap,l.set(ne,Z));let oe=Z.get(I);oe===void 0&&(oe=s.getUniformBlockIndex(ne,I.name),Z.set(I,oe))}function Re(I,ne){let oe=l.get(ne).get(I);c.get(ne)!==oe&&(s.uniformBlockBinding(ne,oe,I.__bindingPointIndex),c.set(ne,oe))}function De(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),s.pixelStorei(s.PACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_ALIGNMENT,4),s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,!1),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,s.BROWSER_DEFAULT_WEBGL),s.pixelStorei(s.PACK_ROW_LENGTH,0),s.pixelStorei(s.PACK_SKIP_PIXELS,0),s.pixelStorei(s.PACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_ROW_LENGTH,0),s.pixelStorei(s.UNPACK_IMAGE_HEIGHT,0),s.pixelStorei(s.UNPACK_SKIP_PIXELS,0),s.pixelStorei(s.UNPACK_SKIP_ROWS,0),s.pixelStorei(s.UNPACK_SKIP_IMAGES,0),h={},d={},ce=null,pe={},u={},f=new WeakMap,g=[],y=null,p=!1,m=null,R=null,C=null,M=null,w=null,S=null,E=null,x=new Ae(0,0,0),A=0,L=!1,b=null,N=null,H=null,Y=null,z=null,ot.set(0,0,s.canvas.width,s.canvas.height),qe.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ee,disable:Ie,bindFramebuffer:Ne,drawBuffers:we,useProgram:ut,setBlending:Ye,setMaterial:Ge,setFlipSided:xt,setCullFace:Tt,setLineWidth:Rt,setPolygonOffset:Pt,setScissorTest:ct,activeTexture:yt,bindTexture:D,unbindTexture:Vt,compressedTexImage2D:Je,compressedTexImage3D:T,texImage2D:q,texImage3D:K,pixelStorei:Se,getParameter:re,updateUBOMapping:Ee,uniformBlockBinding:Re,texStorage2D:te,texStorage3D:se,texSubImage2D:_,texSubImage3D:F,compressedTexSubImage2D:k,compressedTexSubImage3D:W,scissor:le,viewport:ae,reset:De}}function y_(s,e,t,n,i,r,a){let o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Fe,h=new WeakMap,d=new Set,u,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(T,_){return g?new OffscreenCanvas(T,_):gs("canvas")}function p(T,_,F){let k=1,W=Je(T);if((W.width>F||W.height>F)&&(k=F/Math.max(W.width,W.height)),k<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let te=Math.floor(k*W.width),se=Math.floor(k*W.height);u===void 0&&(u=y(te,se));let q=_?y(te,se):u;return q.width=te,q.height=se,q.getContext("2d").drawImage(T,0,0,te,se),ve("WebGLRenderer: Texture has been resized from ("+W.width+"x"+W.height+") to ("+te+"x"+se+")."),q}else return"data"in T&&ve("WebGLRenderer: Image in DataTexture is too big ("+W.width+"x"+W.height+")."),T;return T}function m(T){return T.generateMipmaps}function R(T){s.generateMipmap(T)}function C(T){return T.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?s.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function M(T,_,F,k,W,te=!1){if(T!==null){if(s[T]!==void 0)return s[T];ve("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let se;k&&(se=e.get("EXT_texture_norm16"),se||ve("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let q=_;if(_===s.RED&&(F===s.FLOAT&&(q=s.R32F),F===s.HALF_FLOAT&&(q=s.R16F),F===s.UNSIGNED_BYTE&&(q=s.R8),F===s.UNSIGNED_SHORT&&se&&(q=se.R16_EXT),F===s.SHORT&&se&&(q=se.R16_SNORM_EXT)),_===s.RED_INTEGER&&(F===s.UNSIGNED_BYTE&&(q=s.R8UI),F===s.UNSIGNED_SHORT&&(q=s.R16UI),F===s.UNSIGNED_INT&&(q=s.R32UI),F===s.BYTE&&(q=s.R8I),F===s.SHORT&&(q=s.R16I),F===s.INT&&(q=s.R32I)),_===s.RG&&(F===s.FLOAT&&(q=s.RG32F),F===s.HALF_FLOAT&&(q=s.RG16F),F===s.UNSIGNED_BYTE&&(q=s.RG8),F===s.UNSIGNED_SHORT&&se&&(q=se.RG16_EXT),F===s.SHORT&&se&&(q=se.RG16_SNORM_EXT)),_===s.RG_INTEGER&&(F===s.UNSIGNED_BYTE&&(q=s.RG8UI),F===s.UNSIGNED_SHORT&&(q=s.RG16UI),F===s.UNSIGNED_INT&&(q=s.RG32UI),F===s.BYTE&&(q=s.RG8I),F===s.SHORT&&(q=s.RG16I),F===s.INT&&(q=s.RG32I)),_===s.RGB_INTEGER&&(F===s.UNSIGNED_BYTE&&(q=s.RGB8UI),F===s.UNSIGNED_SHORT&&(q=s.RGB16UI),F===s.UNSIGNED_INT&&(q=s.RGB32UI),F===s.BYTE&&(q=s.RGB8I),F===s.SHORT&&(q=s.RGB16I),F===s.INT&&(q=s.RGB32I)),_===s.RGBA_INTEGER&&(F===s.UNSIGNED_BYTE&&(q=s.RGBA8UI),F===s.UNSIGNED_SHORT&&(q=s.RGBA16UI),F===s.UNSIGNED_INT&&(q=s.RGBA32UI),F===s.BYTE&&(q=s.RGBA8I),F===s.SHORT&&(q=s.RGBA16I),F===s.INT&&(q=s.RGBA32I)),_===s.RGB&&(F===s.UNSIGNED_SHORT&&se&&(q=se.RGB16_EXT),F===s.SHORT&&se&&(q=se.RGB16_SNORM_EXT),F===s.UNSIGNED_INT_5_9_9_9_REV&&(q=s.RGB9_E5),F===s.UNSIGNED_INT_10F_11F_11F_REV&&(q=s.R11F_G11F_B10F)),_===s.RGBA){let K=te?Qs:ze.getTransfer(W);F===s.FLOAT&&(q=s.RGBA32F),F===s.HALF_FLOAT&&(q=s.RGBA16F),F===s.UNSIGNED_BYTE&&(q=K===Ke?s.SRGB8_ALPHA8:s.RGBA8),F===s.UNSIGNED_SHORT&&se&&(q=se.RGBA16_EXT),F===s.SHORT&&se&&(q=se.RGBA16_SNORM_EXT),F===s.UNSIGNED_SHORT_4_4_4_4&&(q=s.RGBA4),F===s.UNSIGNED_SHORT_5_5_5_1&&(q=s.RGB5_A1)}return(q===s.R16F||q===s.R32F||q===s.RG16F||q===s.RG32F||q===s.RGBA16F||q===s.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function w(T,_){let F;return T?_===null||_===Tn||_===Ls?F=s.DEPTH24_STENCIL8:_===Qt?F=s.DEPTH32F_STENCIL8:_===Ps&&(F=s.DEPTH24_STENCIL8,ve("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Tn||_===Ls?F=s.DEPTH_COMPONENT24:_===Qt?F=s.DEPTH_COMPONENT32F:_===Ps&&(F=s.DEPTH_COMPONENT16),F}function S(T,_){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==mt&&T.minFilter!==gt?Math.log2(Math.max(_.width,_.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?_.mipmaps.length:1}function E(T){let _=T.target;_.removeEventListener("dispose",E),A(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&d.delete(_)}function x(T){let _=T.target;_.removeEventListener("dispose",x),b(_)}function A(T){let _=n.get(T);if(_.__webglInit===void 0)return;let F=T.source,k=f.get(F);if(k){let W=k[_.__cacheKey];W.usedTimes--,W.usedTimes===0&&L(T),Object.keys(k).length===0&&f.delete(F)}n.remove(T)}function L(T){let _=n.get(T);s.deleteTexture(_.__webglTexture);let F=T.source,k=f.get(F);delete k[_.__cacheKey],a.memory.textures--}function b(T){let _=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let W=0;W<_.__webglFramebuffer[k].length;W++)s.deleteFramebuffer(_.__webglFramebuffer[k][W]);else s.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)s.deleteFramebuffer(_.__webglFramebuffer[k]);else s.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&s.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&s.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&s.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&s.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let F=T.textures;for(let k=0,W=F.length;k<W;k++){let te=n.get(F[k]);te.__webglTexture&&(s.deleteTexture(te.__webglTexture),a.memory.textures--),n.remove(F[k])}n.remove(T)}let N=0;function H(){N=0}function Y(){return N}function z(T){N=T}function X(){let T=N;return T>=i.maxTextures&&ve("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),N+=1,T}function G(T){let _=[];return _.push(T.wrapS),_.push(T.wrapT),_.push(T.wrapR||0),_.push(T.magFilter),_.push(T.minFilter),_.push(T.anisotropy),_.push(T.internalFormat),_.push(T.format),_.push(T.type),_.push(T.generateMipmaps),_.push(T.premultiplyAlpha),_.push(T.flipY),_.push(T.unpackAlignment),_.push(T.colorSpace),_.join()}function $(T,_){let F=n.get(T);if(T.isVideoTexture&&D(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&F.__version!==T.version){let k=T.image;if(k===null)ve("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)ve("WebGLRenderer: Texture marked for update but image is incomplete");else{Ie(F,T,_);return}}else T.isExternalTexture&&(F.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(s.TEXTURE_2D,F.__webglTexture,s.TEXTURE0+_)}function Q(T,_){let F=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&F.__version!==T.version){Ie(F,T,_);return}else T.isExternalTexture&&(F.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(s.TEXTURE_2D_ARRAY,F.__webglTexture,s.TEXTURE0+_)}function ce(T,_){let F=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&F.__version!==T.version){Ie(F,T,_);return}t.bindTexture(s.TEXTURE_3D,F.__webglTexture,s.TEXTURE0+_)}function pe(T,_){let F=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&F.__version!==T.version){Ne(F,T,_);return}t.bindTexture(s.TEXTURE_CUBE_MAP,F.__webglTexture,s.TEXTURE0+_)}let _e={[mi]:s.REPEAT,[sn]:s.CLAMP_TO_EDGE,[ps]:s.MIRRORED_REPEAT},Xe={[mt]:s.NEAREST,[Za]:s.NEAREST_MIPMAP_NEAREST,[Xi]:s.NEAREST_MIPMAP_LINEAR,[gt]:s.LINEAR,[Is]:s.LINEAR_MIPMAP_NEAREST,[bn]:s.LINEAR_MIPMAP_LINEAR},ot={[Eu]:s.NEVER,[Iu]:s.ALWAYS,[Au]:s.LESS,[Fo]:s.LEQUAL,[wu]:s.EQUAL,[Oo]:s.GEQUAL,[Ru]:s.GREATER,[Cu]:s.NOTEQUAL};function qe(T,_){if(_.type===Qt&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===gt||_.magFilter===Is||_.magFilter===Xi||_.magFilter===bn||_.minFilter===gt||_.minFilter===Is||_.minFilter===Xi||_.minFilter===bn)&&ve("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(T,s.TEXTURE_WRAP_S,_e[_.wrapS]),s.texParameteri(T,s.TEXTURE_WRAP_T,_e[_.wrapT]),(T===s.TEXTURE_3D||T===s.TEXTURE_2D_ARRAY)&&s.texParameteri(T,s.TEXTURE_WRAP_R,_e[_.wrapR]),s.texParameteri(T,s.TEXTURE_MAG_FILTER,Xe[_.magFilter]),s.texParameteri(T,s.TEXTURE_MIN_FILTER,Xe[_.minFilter]),_.compareFunction&&(s.texParameteri(T,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(T,s.TEXTURE_COMPARE_FUNC,ot[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===mt||_.minFilter!==Xi&&_.minFilter!==bn||_.type===Qt&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let F=e.get("EXT_texture_filter_anisotropic");s.texParameterf(T,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,i.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function J(T,_){let F=!1;T.__webglInit===void 0&&(T.__webglInit=!0,_.addEventListener("dispose",E));let k=_.source,W=f.get(k);W===void 0&&(W={},f.set(k,W));let te=G(_);if(te!==T.__cacheKey){W[te]===void 0&&(W[te]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,F=!0),W[te].usedTimes++;let se=W[T.__cacheKey];se!==void 0&&(W[T.__cacheKey].usedTimes--,se.usedTimes===0&&L(_)),T.__cacheKey=te,T.__webglTexture=W[te].texture}return F}function ie(T,_,F){return Math.floor(Math.floor(T/F)/_)}function ee(T,_,F,k){let te=T.updateRanges;if(te.length===0)t.texSubImage2D(s.TEXTURE_2D,0,0,0,_.width,_.height,F,k,_.data);else{te.sort((Se,le)=>Se.start-le.start);let se=0;for(let Se=1;Se<te.length;Se++){let le=te[se],ae=te[Se],Ee=le.start+le.count,Re=ie(ae.start,_.width,4),De=ie(le.start,_.width,4);ae.start<=Ee+1&&Re===De&&ie(ae.start+ae.count-1,_.width,4)===Re?le.count=Math.max(le.count,ae.start+ae.count-le.start):(++se,te[se]=ae)}te.length=se+1;let q=t.getParameter(s.UNPACK_ROW_LENGTH),K=t.getParameter(s.UNPACK_SKIP_PIXELS),re=t.getParameter(s.UNPACK_SKIP_ROWS);t.pixelStorei(s.UNPACK_ROW_LENGTH,_.width);for(let Se=0,le=te.length;Se<le;Se++){let ae=te[Se],Ee=Math.floor(ae.start/4),Re=Math.ceil(ae.count/4),De=Ee%_.width,I=Math.floor(Ee/_.width),ne=Re,Z=1;t.pixelStorei(s.UNPACK_SKIP_PIXELS,De),t.pixelStorei(s.UNPACK_SKIP_ROWS,I),t.texSubImage2D(s.TEXTURE_2D,0,De,I,ne,Z,F,k,_.data)}T.clearUpdateRanges(),t.pixelStorei(s.UNPACK_ROW_LENGTH,q),t.pixelStorei(s.UNPACK_SKIP_PIXELS,K),t.pixelStorei(s.UNPACK_SKIP_ROWS,re)}}function Ie(T,_,F){let k=s.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=s.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=s.TEXTURE_3D);let W=J(T,_),te=_.source;t.bindTexture(k,T.__webglTexture,s.TEXTURE0+F);let se=n.get(te);if(te.version!==se.__version||W===!0){if(t.activeTexture(s.TEXTURE0+F),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let Z=ze.getPrimaries(ze.workingColorSpace),oe=_.colorSpace===ti?null:ze.getPrimaries(_.colorSpace),fe=_.colorSpace===ti||Z===oe?s.NONE:s.BROWSER_DEFAULT_WEBGL;t.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe)}t.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment);let K=p(_.image,!1,i.maxTextureSize);K=Vt(_,K);let re=r.convert(_.format,_.colorSpace),Se=r.convert(_.type),le=M(_.internalFormat,re,Se,_.normalized,_.colorSpace,_.isVideoTexture);qe(k,_);let ae,Ee=_.mipmaps,Re=_.isVideoTexture!==!0,De=se.__version===void 0||W===!0,I=te.dataReady,ne=S(_,K);if(_.isDepthTexture)le=w(_.format===vi,_.type),De&&(Re?t.texStorage2D(s.TEXTURE_2D,1,le,K.width,K.height):t.texImage2D(s.TEXTURE_2D,0,le,K.width,K.height,0,re,Se,null));else if(_.isDataTexture)if(Ee.length>0){Re&&De&&t.texStorage2D(s.TEXTURE_2D,ne,le,Ee[0].width,Ee[0].height);for(let Z=0,oe=Ee.length;Z<oe;Z++)ae=Ee[Z],Re?I&&t.texSubImage2D(s.TEXTURE_2D,Z,0,0,ae.width,ae.height,re,Se,ae.data):t.texImage2D(s.TEXTURE_2D,Z,le,ae.width,ae.height,0,re,Se,ae.data);_.generateMipmaps=!1}else Re?(De&&t.texStorage2D(s.TEXTURE_2D,ne,le,K.width,K.height),I&&ee(_,K,re,Se)):t.texImage2D(s.TEXTURE_2D,0,le,K.width,K.height,0,re,Se,K.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Re&&De&&t.texStorage3D(s.TEXTURE_2D_ARRAY,ne,le,Ee[0].width,Ee[0].height,K.depth);for(let Z=0,oe=Ee.length;Z<oe;Z++)if(ae=Ee[Z],_.format!==en)if(re!==null)if(Re){if(I)if(_.layerUpdates.size>0){let fe=ol(ae.width,ae.height,_.format,_.type);for(let j of _.layerUpdates){let Me=ae.data.subarray(j*fe/ae.data.BYTES_PER_ELEMENT,(j+1)*fe/ae.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Z,0,0,j,ae.width,ae.height,1,re,Me)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Z,0,0,0,ae.width,ae.height,K.depth,re,ae.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Z,le,ae.width,ae.height,K.depth,0,ae.data,0,0);else ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Re?I&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,Z,0,0,0,ae.width,ae.height,K.depth,re,Se,ae.data):t.texImage3D(s.TEXTURE_2D_ARRAY,Z,le,ae.width,ae.height,K.depth,0,re,Se,ae.data)}else{Re&&De&&t.texStorage2D(s.TEXTURE_2D,ne,le,Ee[0].width,Ee[0].height);for(let Z=0,oe=Ee.length;Z<oe;Z++)ae=Ee[Z],_.format!==en?re!==null?Re?I&&t.compressedTexSubImage2D(s.TEXTURE_2D,Z,0,0,ae.width,ae.height,re,ae.data):t.compressedTexImage2D(s.TEXTURE_2D,Z,le,ae.width,ae.height,0,ae.data):ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Re?I&&t.texSubImage2D(s.TEXTURE_2D,Z,0,0,ae.width,ae.height,re,Se,ae.data):t.texImage2D(s.TEXTURE_2D,Z,le,ae.width,ae.height,0,re,Se,ae.data)}else if(_.isDataArrayTexture)if(Re){if(De&&t.texStorage3D(s.TEXTURE_2D_ARRAY,ne,le,K.width,K.height,K.depth),I)if(_.layerUpdates.size>0){let Z=ol(K.width,K.height,_.format,_.type);for(let oe of _.layerUpdates){let fe=K.data.subarray(oe*Z/K.data.BYTES_PER_ELEMENT,(oe+1)*Z/K.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,oe,K.width,K.height,1,re,Se,fe)}_.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,re,Se,K.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,le,K.width,K.height,K.depth,0,re,Se,K.data);else if(_.isData3DTexture)Re?(De&&t.texStorage3D(s.TEXTURE_3D,ne,le,K.width,K.height,K.depth),I&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,re,Se,K.data)):t.texImage3D(s.TEXTURE_3D,0,le,K.width,K.height,K.depth,0,re,Se,K.data);else if(_.isFramebufferTexture){if(De)if(Re)t.texStorage2D(s.TEXTURE_2D,ne,le,K.width,K.height);else{let Z=K.width,oe=K.height;for(let fe=0;fe<ne;fe++)t.texImage2D(s.TEXTURE_2D,fe,le,Z,oe,0,re,Se,null),Z>>=1,oe>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in s){let Z=s.canvas;if(Z.hasAttribute("layoutsubtree")||Z.setAttribute("layoutsubtree","true"),K.parentNode!==Z){Z.appendChild(K),d.add(_),Z.onpaint=oe=>{let fe=oe.changedElements;for(let j of d)fe.includes(j.image)&&(j.needsUpdate=!0)},Z.requestPaint();return}if(s.texElementImage2D.length===3)s.texElementImage2D(s.TEXTURE_2D,s.RGBA8,K);else{let fe=s.RGBA,j=s.RGBA,Me=s.UNSIGNED_BYTE;s.texElementImage2D(s.TEXTURE_2D,0,fe,j,Me,K)}s.texParameteri(s.TEXTURE_2D,s.TEXTURE_MIN_FILTER,s.LINEAR),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(s.TEXTURE_2D,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE)}}else if(Ee.length>0){if(Re&&De){let Z=Je(Ee[0]);t.texStorage2D(s.TEXTURE_2D,ne,le,Z.width,Z.height)}for(let Z=0,oe=Ee.length;Z<oe;Z++)ae=Ee[Z],Re?I&&t.texSubImage2D(s.TEXTURE_2D,Z,0,0,re,Se,ae):t.texImage2D(s.TEXTURE_2D,Z,le,re,Se,ae);_.generateMipmaps=!1}else if(Re){if(De){let Z=Je(K);t.texStorage2D(s.TEXTURE_2D,ne,le,Z.width,Z.height)}I&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,re,Se,K)}else t.texImage2D(s.TEXTURE_2D,0,le,re,Se,K);m(_)&&R(k),se.__version=te.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function Ne(T,_,F){if(_.image.length!==6)return;let k=J(T,_),W=_.source;t.bindTexture(s.TEXTURE_CUBE_MAP,T.__webglTexture,s.TEXTURE0+F);let te=n.get(W);if(W.version!==te.__version||k===!0){t.activeTexture(s.TEXTURE0+F);let se=ze.getPrimaries(ze.workingColorSpace),q=_.colorSpace===ti?null:ze.getPrimaries(_.colorSpace),K=_.colorSpace===ti||se===q?s.NONE:s.BROWSER_DEFAULT_WEBGL;t.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(s.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);let re=_.isCompressedTexture||_.image[0].isCompressedTexture,Se=_.image[0]&&_.image[0].isDataTexture,le=[];for(let j=0;j<6;j++)!re&&!Se?le[j]=p(_.image[j],!0,i.maxCubemapSize):le[j]=Se?_.image[j].image:_.image[j],le[j]=Vt(_,le[j]);let ae=le[0],Ee=r.convert(_.format,_.colorSpace),Re=r.convert(_.type),De=M(_.internalFormat,Ee,Re,_.normalized,_.colorSpace),I=_.isVideoTexture!==!0,ne=te.__version===void 0||k===!0,Z=W.dataReady,oe=S(_,ae);qe(s.TEXTURE_CUBE_MAP,_);let fe;if(re){I&&ne&&t.texStorage2D(s.TEXTURE_CUBE_MAP,oe,De,ae.width,ae.height);for(let j=0;j<6;j++){fe=le[j].mipmaps;for(let Me=0;Me<fe.length;Me++){let xe=fe[Me];_.format!==en?Ee!==null?I?Z&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,xe.width,xe.height,Ee,xe.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,De,xe.width,xe.height,0,xe.data):ve("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?Z&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,xe.width,xe.height,Ee,Re,xe.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,De,xe.width,xe.height,0,Ee,Re,xe.data)}}}else{if(fe=_.mipmaps,I&&ne){fe.length>0&&oe++;let j=Je(le[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,oe,De,j.width,j.height)}for(let j=0;j<6;j++)if(Se){I?Z&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,le[j].width,le[j].height,Ee,Re,le[j].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,De,le[j].width,le[j].height,0,Ee,Re,le[j].data);for(let Me=0;Me<fe.length;Me++){let lt=fe[Me].image[j].image;I?Z&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,lt.width,lt.height,Ee,Re,lt.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,De,lt.width,lt.height,0,Ee,Re,lt.data)}}else{I?Z&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Ee,Re,le[j]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,De,Ee,Re,le[j]);for(let Me=0;Me<fe.length;Me++){let xe=fe[Me];I?Z&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,Ee,Re,xe.image[j]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,De,Ee,Re,xe.image[j])}}}m(_)&&R(s.TEXTURE_CUBE_MAP),te.__version=W.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function we(T,_,F,k,W,te){let se=r.convert(F.format,F.colorSpace),q=r.convert(F.type),K=M(F.internalFormat,se,q,F.normalized,F.colorSpace),re=n.get(_),Se=n.get(F);if(Se.__renderTarget=_,!re.__hasExternalTextures){let le=Math.max(1,_.width>>te),ae=Math.max(1,_.height>>te);W===s.TEXTURE_3D||W===s.TEXTURE_2D_ARRAY?t.texImage3D(W,te,K,le,ae,_.depth,0,se,q,null):t.texImage2D(W,te,K,le,ae,0,se,q,null)}t.bindFramebuffer(s.FRAMEBUFFER,T),yt(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,k,W,Se.__webglTexture,0,ct(_)):(W===s.TEXTURE_2D||W>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&W<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,k,W,Se.__webglTexture,te),t.bindFramebuffer(s.FRAMEBUFFER,null)}function ut(T,_,F){if(s.bindRenderbuffer(s.RENDERBUFFER,T),_.depthBuffer){let k=_.depthTexture,W=k&&k.isDepthTexture?k.type:null,te=w(_.stencilBuffer,W),se=_.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;yt(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ct(_),te,_.width,_.height):F?s.renderbufferStorageMultisample(s.RENDERBUFFER,ct(_),te,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,te,_.width,_.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,se,s.RENDERBUFFER,T)}else{let k=_.textures;for(let W=0;W<k.length;W++){let te=k[W],se=r.convert(te.format,te.colorSpace),q=r.convert(te.type),K=M(te.internalFormat,se,q,te.normalized,te.colorSpace);yt(_)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,ct(_),K,_.width,_.height):F?s.renderbufferStorageMultisample(s.RENDERBUFFER,ct(_),K,_.width,_.height):s.renderbufferStorage(s.RENDERBUFFER,K,_.width,_.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function He(T,_,F){let k=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(s.FRAMEBUFFER,T),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let W=n.get(_.depthTexture);if(W.__renderTarget=_,(!W.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),k){if(W.__webglInit===void 0&&(W.__webglInit=!0,_.depthTexture.addEventListener("dispose",E)),W.__webglTexture===void 0){W.__webglTexture=s.createTexture(),t.bindTexture(s.TEXTURE_CUBE_MAP,W.__webglTexture),qe(s.TEXTURE_CUBE_MAP,_.depthTexture);let re=r.convert(_.depthTexture.format),Se=r.convert(_.depthTexture.type),le;_.depthTexture.format===Pn?le=s.DEPTH_COMPONENT24:_.depthTexture.format===vi&&(le=s.DEPTH24_STENCIL8);for(let ae=0;ae<6;ae++)s.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,le,_.width,_.height,0,re,Se,null)}}else $(_.depthTexture,0);let te=W.__webglTexture,se=ct(_),q=k?s.TEXTURE_CUBE_MAP_POSITIVE_X+F:s.TEXTURE_2D,K=_.depthTexture.format===vi?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;if(_.depthTexture.format===Pn)yt(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,K,q,te,0,se):s.framebufferTexture2D(s.FRAMEBUFFER,K,q,te,0);else if(_.depthTexture.format===vi)yt(_)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,K,q,te,0,se):s.framebufferTexture2D(s.FRAMEBUFFER,K,q,te,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function tt(T){let _=n.get(T),F=T.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==T.depthTexture){let k=T.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),k){let W=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,k.removeEventListener("dispose",W)};k.addEventListener("dispose",W),_.__depthDisposeCallback=W}_.__boundDepthTexture=k}if(T.depthTexture&&!_.__autoAllocateDepthBuffer)if(F)for(let k=0;k<6;k++)He(_.__webglFramebuffer[k],T,k);else{let k=T.texture.mipmaps;k&&k.length>0?He(_.__webglFramebuffer[0],T,0):He(_.__webglFramebuffer,T,0)}else if(F){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]===void 0)_.__webglDepthbuffer[k]=s.createRenderbuffer(),ut(_.__webglDepthbuffer[k],T,!1);else{let W=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,te=_.__webglDepthbuffer[k];s.bindRenderbuffer(s.RENDERBUFFER,te),s.framebufferRenderbuffer(s.FRAMEBUFFER,W,s.RENDERBUFFER,te)}}else{let k=T.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(s.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=s.createRenderbuffer(),ut(_.__webglDepthbuffer,T,!1);else{let W=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,te=_.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,te),s.framebufferRenderbuffer(s.FRAMEBUFFER,W,s.RENDERBUFFER,te)}}t.bindFramebuffer(s.FRAMEBUFFER,null)}function Ye(T,_,F){let k=n.get(T);_!==void 0&&we(k.__webglFramebuffer,T,T.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),F!==void 0&&tt(T)}function Ge(T){let _=T.texture,F=n.get(T),k=n.get(_);T.addEventListener("dispose",x);let W=T.textures,te=T.isWebGLCubeRenderTarget===!0,se=W.length>1;if(se||(k.__webglTexture===void 0&&(k.__webglTexture=s.createTexture()),k.__version=_.version,a.memory.textures++),te){F.__webglFramebuffer=[];for(let q=0;q<6;q++)if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer[q]=[];for(let K=0;K<_.mipmaps.length;K++)F.__webglFramebuffer[q][K]=s.createFramebuffer()}else F.__webglFramebuffer[q]=s.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){F.__webglFramebuffer=[];for(let q=0;q<_.mipmaps.length;q++)F.__webglFramebuffer[q]=s.createFramebuffer()}else F.__webglFramebuffer=s.createFramebuffer();if(se)for(let q=0,K=W.length;q<K;q++){let re=n.get(W[q]);re.__webglTexture===void 0&&(re.__webglTexture=s.createTexture(),a.memory.textures++)}if(T.samples>0&&yt(T)===!1){F.__webglMultisampledFramebuffer=s.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let q=0;q<W.length;q++){let K=W[q];F.__webglColorRenderbuffer[q]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,F.__webglColorRenderbuffer[q]);let re=r.convert(K.format,K.colorSpace),Se=r.convert(K.type),le=M(K.internalFormat,re,Se,K.normalized,K.colorSpace,T.isXRRenderTarget===!0),ae=ct(T);s.renderbufferStorageMultisample(s.RENDERBUFFER,ae,le,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+q,s.RENDERBUFFER,F.__webglColorRenderbuffer[q])}s.bindRenderbuffer(s.RENDERBUFFER,null),T.depthBuffer&&(F.__webglDepthRenderbuffer=s.createRenderbuffer(),ut(F.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(te){t.bindTexture(s.TEXTURE_CUBE_MAP,k.__webglTexture),qe(s.TEXTURE_CUBE_MAP,_);for(let q=0;q<6;q++)if(_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)we(F.__webglFramebuffer[q][K],T,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+q,K);else we(F.__webglFramebuffer[q],T,_,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+q,0);m(_)&&R(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(se){for(let q=0,K=W.length;q<K;q++){let re=W[q],Se=n.get(re),le=s.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(le=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(le,Se.__webglTexture),qe(le,re),we(F.__webglFramebuffer,T,re,s.COLOR_ATTACHMENT0+q,le,0),m(re)&&R(le)}t.unbindTexture()}else{let q=s.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(q=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(q,k.__webglTexture),qe(q,_),_.mipmaps&&_.mipmaps.length>0)for(let K=0;K<_.mipmaps.length;K++)we(F.__webglFramebuffer[K],T,_,s.COLOR_ATTACHMENT0,q,K);else we(F.__webglFramebuffer,T,_,s.COLOR_ATTACHMENT0,q,0);m(_)&&R(q),t.unbindTexture()}T.depthBuffer&&tt(T)}function xt(T){let _=T.textures;for(let F=0,k=_.length;F<k;F++){let W=_[F];if(m(W)){let te=C(T),se=n.get(W).__webglTexture;t.bindTexture(te,se),R(te),t.unbindTexture()}}}let Tt=[],Rt=[];function Pt(T){if(T.samples>0){if(yt(T)===!1){let _=T.textures,F=T.width,k=T.height,W=s.COLOR_BUFFER_BIT,te=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,se=n.get(T),q=_.length>1;if(q)for(let re=0;re<_.length;re++)t.bindFramebuffer(s.FRAMEBUFFER,se.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+re,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,se.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+re,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,se.__webglMultisampledFramebuffer);let K=T.texture.mipmaps;K&&K.length>0?t.bindFramebuffer(s.DRAW_FRAMEBUFFER,se.__webglFramebuffer[0]):t.bindFramebuffer(s.DRAW_FRAMEBUFFER,se.__webglFramebuffer);for(let re=0;re<_.length;re++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(W|=s.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(W|=s.STENCIL_BUFFER_BIT)),q){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,se.__webglColorRenderbuffer[re]);let Se=n.get(_[re]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Se,0)}s.blitFramebuffer(0,0,F,k,0,0,F,k,W,s.NEAREST),c===!0&&(Tt.length=0,Rt.length=0,Tt.push(s.COLOR_ATTACHMENT0+re),T.depthBuffer&&T.resolveDepthBuffer===!1&&(Tt.push(te),Rt.push(te),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Rt)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Tt))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),q)for(let re=0;re<_.length;re++){t.bindFramebuffer(s.FRAMEBUFFER,se.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+re,s.RENDERBUFFER,se.__webglColorRenderbuffer[re]);let Se=n.get(_[re]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,se.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+re,s.TEXTURE_2D,Se,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,se.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&c){let _=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[_])}}}function ct(T){return Math.min(i.maxSamples,T.samples)}function yt(T){let _=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function D(T){let _=a.render.frame;h.get(T)!==_&&(h.set(T,_),T.update())}function Vt(T,_){let F=T.colorSpace,k=T.format,W=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||F!==Bt&&F!==ti&&(ze.getTransfer(F)===Ke?(k!==en||W!==qt)&&ve("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ce("WebGLTextures: Unsupported texture color space:",F)),_}function Je(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(l.width=T.naturalWidth||T.width,l.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(l.width=T.displayWidth,l.height=T.displayHeight):(l.width=T.width,l.height=T.height),l}this.allocateTextureUnit=X,this.resetTextureUnits=H,this.getTextureUnits=Y,this.setTextureUnits=z,this.setTexture2D=$,this.setTexture2DArray=Q,this.setTexture3D=ce,this.setTextureCube=pe,this.rebindTextures=Ye,this.setupRenderTarget=Ge,this.updateRenderTargetMipmap=xt,this.updateMultisampleRenderTarget=Pt,this.setupDepthRenderbuffer=tt,this.setupFrameBufferTexture=we,this.useMultisampledRTT=yt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function v_(s,e){function t(n,i=ti){let r,a=ze.getTransfer(i);if(n===qt)return s.UNSIGNED_BYTE;if(n===Ja)return s.UNSIGNED_SHORT_4_4_4_4;if(n===$a)return s.UNSIGNED_SHORT_5_5_5_1;if(n===Jc)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===$c)return s.UNSIGNED_INT_10F_11F_11F_REV;if(n===Zc)return s.BYTE;if(n===Kc)return s.SHORT;if(n===Ps)return s.UNSIGNED_SHORT;if(n===Ka)return s.INT;if(n===Tn)return s.UNSIGNED_INT;if(n===Qt)return s.FLOAT;if(n===Un)return s.HALF_FLOAT;if(n===jc)return s.ALPHA;if(n===Qc)return s.RGB;if(n===en)return s.RGBA;if(n===Pn)return s.DEPTH_COMPONENT;if(n===vi)return s.DEPTH_STENCIL;if(n===ja)return s.RED;if(n===Qa)return s.RED_INTEGER;if(n===Mi)return s.RG;if(n===eo)return s.RG_INTEGER;if(n===to)return s.RGBA_INTEGER;if(n===wr||n===Rr||n===Cr||n===Ir)if(a===Ke)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===wr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Rr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Cr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ir)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===wr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Rr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Cr)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ir)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===no||n===io||n===so||n===ro)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===no)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===io)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===so)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ro)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ao||n===oo||n===co||n===lo||n===ho||n===Pr||n===uo)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===ao||n===oo)return a===Ke?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===co)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===lo)return r.COMPRESSED_R11_EAC;if(n===ho)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Pr)return r.COMPRESSED_RG11_EAC;if(n===uo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===fo||n===po||n===mo||n===go||n===_o||n===xo||n===yo||n===vo||n===Mo||n===So||n===bo||n===To||n===Eo||n===Ao)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===fo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===po)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===mo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===go)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===_o)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===xo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===yo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===vo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Mo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===So)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===bo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===To)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Eo)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ao)return a===Ke?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===wo||n===Ro||n===Co)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===wo)return a===Ke?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ro)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Co)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Io||n===Po||n===Lr||n===Lo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Io)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Po)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Lr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Lo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ls?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}var M_=`
void main() {
