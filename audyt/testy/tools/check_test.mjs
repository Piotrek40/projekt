...
// Uruchom: node audyt/testy/tools/check_test.mjs → oczekiwane 7 nieudanych asercji (celowo złe dane: 6 FAIL + 1 dodatkowy wpis pary koplanarnej)
// i 0 fałszywych alarmów w wierszach OK; kod wyjścia 1, gdy liczba ≠ 7.
...
const { check, checkInFrontOfWall, checkHeight, checkAboveGround, checkNoCoplanar, checkCollisionCovers, facadeNormal, checkFailures } = await import('../../../engine/src/check.js');
...
console.log('nieudanych asercji:', checkFailures(), '(oczekiwane 7: 6 FAIL + 1 dodatkowy wpis pary koplanarnej)');
process.exit(checkFailures() === 7 ? 0 : 1);
