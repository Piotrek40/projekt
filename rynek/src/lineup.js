...
export const MAT_KEYS = ['cobble', 'stone', 'blocks', 'slates', 'timber', 'planks', 'door', 'plaster0', 'plaster1', 'plaster2', 'plaster3', 'plaster4', 'roof0', 'roof1', 'roof2', 'roofTower', 'cloth0', 'cloth1', 'cloth2', 'cloth3', 'glass', 'glassLit', 'iron', 'water', 'flame', 'banner0', 'banner1', 'banner2', 'banner3']; // = Object.keys(W.mat) po buildMaterials
...
export function buildLineup(W, filter = '1') {
  ...
  if (filter === '1') check(keys.join() === MAT_KEYS.join(), 'lineup: MAT_KEYS ≠ Object.keys(W.mat) — zaktualizuj MAT_KEYS w lineup.js i przelicz lineup_rects', { keys });
